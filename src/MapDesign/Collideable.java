...
public interface Collideable {
     ...
     * @param other The other Collideable object which the object implementing Collideable is being checked against.
     * @return The other Collideable if collision is found, or null if there is no collision between the two objects.
     */
     ...
     * @param other The other Collideable object to be checked against.
    ...
    /**
     * Returns a boolean which determines if a Collideable is an obstacle. Often used in Collision logic outside the interface.
     * @return A boolean which determines if a Collideable is an obstacle. Often used in Collision logic outside the interface.
     */

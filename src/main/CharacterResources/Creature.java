package main.CharacterResources;
...
public abstract class Creature implements Collideable
{
     ...
     * @param collideables Main.Collision.Collideable HashSet which contains collideables to be checked against.
    ...
    /**
     * Checks if Creature can move in specified direction. With the context of one specific Main.Collision.Collideable.
     ...
     * @param direction Direction of attempted movement as type String.
     * @param other Main.Collision.Collideable to be checked against.
     * @return A boolean value which determines whether or not player can move in specified direction.
     */
    ...
    /**
     * Necessary to satisfy Main.Collision.Collideable interface. Declares a Creature as an obstacle.
     * This will make move methods of other Collideables that also return true for this method ensure creatures cannot overlap.
     * @return A boolean which determines whether a Main.Collision.Collideable is an obstacle.
     */
    @Override

 ...
 */
public abstract class Player extends Creature implements Updateable
{
    /**
     ...
     * @param collideables A HashSet of type Main.Collision.Collideable, used to check for collision in super call.
     */
    @Override
    public void move(String direction, HashSet<main.Collision.Collideable> collideables)
    {
